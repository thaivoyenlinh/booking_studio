...
//   const EmployeeAppointmentConfirmedPage({Key? key, required this.user, required this.employeeId}) : super(key: key);
//   final AuthModel user;
//   final int employeeId;  
  
//   @override
//   State<EmployeeAppointmentConfirmedPage> createState() => _EmployeeAppointmentConfirmedPageState();
// }

// class _EmployeeAppointmentConfirmedPageState extends State<EmployeeAppointmentConfirmedPage> {
...
//     bool history = false;
//     var status = 1;
//     var url = beEnvUrl + "/schedule/getSchedulesByEmployee?EmployeeId=${widget.employeeId}&Status=${status}&History=${history}";
...
//                         Gap(5),
//                         Text(item.headerDateReschedule != "" ? item.headerDateReschedule : item.headerDate, style: TextStyle(fontWeight: FontWeight.bold),),
//                         Gap(5),
...
//     required this.headerDateReschedule
//     });
// }
...
//       isExpanded: false,
//       headerDateReschedule: schedule['dateReschedule'] != null ? schedule['dateReschedule'] : "",
//     );
//   });
// }