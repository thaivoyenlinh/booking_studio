...
import {
  ...
  IEmployeeDetail,
  IEmployeesListQuery,
} from 'src/app/models/employee/employee.model';
...
import {
  ...
  Sort,
  SortBy,
} from 'src/app/models/employee/employee-sort.model';
...
export class EmployeeComponent implements OnInit {
  ...
  queryEmployeesListObservable(
    query: Partial<IEmployeesListQuery>
  ): Observable<IEmployeeDetail[]> {
  ...
  clkInformationDetails(element){
    // console.log(element);
    this.employeeService.getEmployeeDetails(element.employeeAccountId).then(
      (res) => {
        if(res) {
          console.log(res);
